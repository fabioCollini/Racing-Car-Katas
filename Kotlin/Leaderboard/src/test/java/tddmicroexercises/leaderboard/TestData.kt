...
object TestData {
    ...
    var driver1 = Driver("Nico Rosberg", "DE")
    var driver2 = Driver("Lewis Hamilton", "UK")
    var driver3 = Driver("Sebastian Vettel", "DE")
    var driver4 = SelfDrivingCar("1.2", "Acme")

    var race1 = Race("Australian Grand Prix", driver1, driver2, driver3)
    var race2: Race
    var race3: Race
    var race4: Race
    var race5: Race
